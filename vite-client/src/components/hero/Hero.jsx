        ...
        <div className="self-intro">
            ...
            <div className='contact-div'>
              <ul className="contact-list">
                <li>
                  <a href="https://www.linkedin.com/in/anmol-koundal-19748a241" target='_blank' title='View Linkedin Profile'>
                ...
                <li>
                  <a href="https://drive.google.com/file/d/1QYbDkVTXCywDPUWSCaPCYQVWR_DNXMxv/view" target='_blank' title='view resume on drive'>Resume</a>
                </li>
              </ul>
